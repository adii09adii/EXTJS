...
folder are mapped to the application's root namespace, 'sencha5Project'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "sencha5Project"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'sencha5Project' in the same way
as `"sencha5Project/sass/src"`.
